...
class VOCBboxDataset:
    ...
    * :obj:`difficult.dtype == numpy.bool`
    ...
    def __init__(self, data_dir, split='test',
        ...
        self.save_dir = '/home/yl/PycharmProjects/UEA/results/VOC2007/frcnn/'
        self.save_dir_adv = '/home/yl/PycharmProjects/UEA/results/VOC2007/frcnn_adv/'
        self.save_dir_comb = '/home/yl/PycharmProjects/UEA/results/VOC2007/frcnn_comb/'
        self.save_dir_perturb = '/home/yl/PycharmProjects/UEA/results/VOC2007/frcnn_perturb/'

    def __len__(self):
        return len(self.ids)

    def preprocess(self, img, min_size=270, max_size=360):
...
if __name__ == '__main__':
    ...
    attacker_path = '/home/yl/PycharmProjects/UEA/checkpoints/10.path'
    ...
    trainer.load('/home/yl/PycharmProjects/UEA/checkpoints/fasterrcnn_12211511_0.701052458187_torchvision_pretrain.pth.701052458187')
    ...
    for quality in threshold:
        ...
        for i in range(len(_data)):
            ...
            save_path = _data.save_dir + 'f0rcnn' + im_path_clone.split('/')[-1]
            ...
            print (save_path_perturb)
            print (save_path_adv)
            cv2.imwrite(save_path, ori_img_.transpose((1, 2, 0)))
            cv2.imwrite(save_path_adv, adv_img_.transpose((1, 2, 0)))
            ...
            if adv_labels[0].size != 0:
                for i in adv_labels[0]:
                    if i in img_labels_lists:
                        adv_detected += 1
                        adv_detected_total += 1
            # if jpg_adv_labels[0].size != 0:
                # jpg_detected += 1
            if _labels[0].size != 0:
                img_detected_total = img_detected_total + _labels[0].size
                img_detected = img_detected + _labels[0].size
            ...
            if i % 100 == 0:
                print("========================================================")
                print("Detected %d faces out of %d" % (img_detected_total, len(_data)))
                print("Detected %d Adversarial faces out of %d" % (adv_detected_total, len(_data)))
                print("========================================================")
        print("Detected %d faces out of %d" %(img_detected_total,len(_data)))
        print("Detected %d Adversarial faces out of %d" %(adv_detected_total,len(_data)))
