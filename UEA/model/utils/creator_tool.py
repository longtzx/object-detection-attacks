...
class ProposalCreator:
    ...
    def __call__(self, loc, score,
                 anchor, img_size, scale=1., flag=False):
        ...
        if flag:
            score_normal = score_normal[order]
        ...
        # keep = nms(cp.ascontiguousarray(cp.asarray(roi)),thresh=self.nms_thresh)
        keep = nms(
        ...
        # score = score_normal[keep.cpu().numpy()]
